	...
	<div class="<?php echo esc_attr( $container ); ?>" id="content" tabindex="-1">
		...
		<div class="row d-flex justify-content-center">
            ...
            <h1 class="text-center">A Man for All Centuries</h1>
                ...
                traditional craftsman and artist, he is now back in IT as a developer.  One has to go where the market is to make a decent living.</p>
                ...
                <p id="craftsman-opening-text">Since he was a teenager, the love of Mark's life has been the American longrifle and longrifle culture.  Over the years,
                    ...
                    a few knives.  Unfortunately, these interests comprise a limited market, and Mark's productivity was never that high.  Making a good living in the traditional crafts has always been elusive.</p>
                ...
                <p id="artist-opening-text">Mark has been an artist his entire life producing art in many different media.  He was in the gifted and talent program for art throughout his
                    ...
                    life, he still sees it only as an avocation as opposed to a profession that can produce a decent living. This is mostly becuase of the media and genre on which
                    ...
                    He also enjoys architectural and landscape photography as much as his physical limitations allow.  
                </p>
